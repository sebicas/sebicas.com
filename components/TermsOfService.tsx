      ...
      <div className="container mx-auto px-6 max-w-4xl">
        ...
        <div className="prose prose-invert max-w-none text-graytext space-y-8 leading-relaxed">
          ...
          <p>
            ...
            of Postiz or its licensors and is protected by intellectual property
            laws. You may not reproduce, modify, distribute, or otherwise use
          ...
          <p>
            ...
            with your use of the Site, the course content, or your subscription
            to the newsletter, whether based on contract, tort, negligence,
            strict liability, or otherwise. Our total liability to you for any
            claim arising out of or in connection with the Site, the course
            content, or your subscription to the newsletter shall not exceed the
            total amount paid by you for the course subscription.
          </p>
          ...
          <p>
            ...
            including without limitation reasonable attorney's fees, arising out
            of or in connection with your use of the Site, the course content,
            or your subscription to the newsletter, your violation of these
          ...
          <p>
            ...
            on social networks you've authenticated with. We may allow you to
            link your account on Postiz with an account on a third-party social
            network platform, such as YouTube, and to transfer your information
            to and from the applicable third-party platform. Once you connect
            your content to a social media platform, its use will be governed by
            its terms. For example, if you choose to connect your YouTube
            account to the Services, this connection uses YouTube's API
            services, and the YouTube Terms of Service located at{" "}
            <a
