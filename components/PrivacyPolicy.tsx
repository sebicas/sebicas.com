    ...
    <div className="min-h-screen bg-dark pt-28 pb-20">
      <div className="container mx-auto px-6 max-w-4xl">
        ...
        <div className="prose prose-invert max-w-none text-graytext space-y-6 leading-relaxed">
          ...
          <p>
            At Postiz ("Company," "we," "us," or "our"), we are committed to protecting the privacy and security of our users' personal information. This Privacy Policy applies to the Sebicas website, the Postiz Sebicas application (the "App"), and all related services. It outlines how we collect, use, and safeguard the personal information collected on our website and through the Postiz Sebicas app. By accessing or using our website, the Postiz Sebicas app, registering for the Website, and providing your personal information, you agree to the terms and conditions of this Privacy Policy.
          </p>

          {/* Section 1 */}
          <h2 className="text-2xl font-bold text-white mt-10 mb-4">1. Our Services</h2>

          <h3 className="text-xl font-semibold text-white mt-6 mb-3">Postiz Services</h3>
          <p>
            Postiz's suite of social media management and social care tools is accessible via our websites and mobile applications. These tools allow you to combine all your social media accounts for easy access and management through a single online platform. Through this platform, you can manage your social media, marketing, and advertising campaigns, engage with your audiences, schedule and publish messages, manage customer care communications, and analyze the results of these activities.
          </p>

          <h3 className="text-xl font-semibold text-white mt-6 mb-3">Social Networks</h3>
          <p>
          ...
          <h3 className="text-xl font-semibold text-white mt-6 mb-3">Your Privacy Obligations</h3>
          <p>
          ...
          <h3 className="text-xl font-semibold text-white mt-6 mb-3">Business Purposes</h3>
          <p>
          ...
          {/* Section 2 */}
          <h2 className="text-2xl font-bold text-white mt-10 mb-4">2. What information do we collect?</h2>
          <p>
            We collect information about you as reasonably necessary for the following activities:
          </p>

          <h3 className="text-xl font-semibold text-white mt-6 mb-3">Using our Services</h3>
          <p>We may collect the following information when you use our Services:</p>

          <h4 className="text-lg font-semibold text-white mt-4 mb-2">Account information:</h4>
          ...
          <h4 className="text-lg font-semibold text-white mt-4 mb-2">Content:</h4>
          <ul className="list-disc pl-6 space-y-2">
          ...
          <h4 className="text-lg font-semibold text-white mt-4 mb-2">Logs, usage, and support data:</h4>
          <ul className="list-disc pl-6 space-y-2">
          ...
          <h3 className="text-xl font-semibold text-white mt-6 mb-3">Surveys, events, marketing, and other activities</h3>
          ...
          <p className="mt-4">Other interactions:</p>
          <ul className="list-disc pl-6 space-y-2">
            <li><strong className="text-white">Social media:</strong> Your messages, posts, and other interactions with our brand and social media accounts.</li>
            <li><strong className="text-white">Email interactions and analytics:</strong> Information on how you engage with our emails, such as email open and click rates, whether a link is clicked, which web pages are visited after opening the email, the type of browser and email clients you use, and general location (i.e., country and region) information.</li>
            <li><strong className="text-white">Teleconference, videoconference, and other meetings:</strong> Your preferences, feedback, opinions, and business needs; and recordings of these sessions if you agree.</li>
            <li><strong className="text-white">Accessing resources</strong> (e.g. videos, whitepapers or case studies) on our website: Your name and contact information, and engagement analytics such as the type and frequency of resources accessed, viewed and downloaded.</li>
          </ul>

          <h3 className="text-xl font-semibold text-white mt-6 mb-3">Browsing our websites</h3>
          ...
          {/* Section 3 */}
          <h2 className="text-2xl font-bold text-white mt-10 mb-4">3. How do we use your information?</h2>
          <p>We use your information for the purposes described below:</p>

          <h3 className="text-xl font-semibold text-white mt-6 mb-3">Providing and securing our Services</h3>
          <ul className="list-disc pl-6 space-y-2">
          ...
          <h3 className="text-xl font-semibold text-white mt-6 mb-3">Communicating with you</h3>
          <p>
          ...
          <h3 className="text-xl font-semibold text-white mt-6 mb-3">Improving our websites and applications</h3>
          <p>
            We use information about you to help us understand usage patterns and other activities on our websites and applications so that we can diagnose problems and make improvements, including enhancing usability and security. We also use website personalization software to help us present information on our websites that may be more relevant to you, such as displaying resources applicable to your industry or organization size. If you choose to provide information about you, your usage of social media services and other feedback during telephone calls and other interactions to our customer support and sales teams, we may use, monitor, and record this information for training purposes, to make improvements to our internal sales and marketing processes, and to improve our Services.
          </p>

          {/* Section 4 */}
          <h2 className="text-2xl font-bold text-white mt-10 mb-4">4. What are your rights regarding the information about you?</h2>

          <h3 className="text-xl font-semibold text-white mt-6 mb-3">Services information</h3>
          <p>
            When using our Services, you may access, update, or correct most of your Account information by logging in to your account to edit your profile or organization record. If you have requests that cannot be carried out by logging in to your account, such as accessing additional information or deleting information about you, please email our privacy team.
          </p>
          <p>
            Please note that we may need to retain certain information about you for as long as you maintain an account for our Services, to provide you with our Services, for record keeping purposes, for payment processing, to comply with our legal and regulatory obligations, to resolve disputes, or to enforce the Postiz Terms of Service, or other agreement in place between you (or your organization) and Postiz.
          </p>
          <p>
          ...
          <h3 className="text-xl font-semibold text-white mt-6 mb-3">Marketing emails, advertising and website browsing</h3>
          <p>
          ...
          <p>
            Postiz participates in interest-based advertising (where you may have visited our websites or another website which allows us to display advertising relating to our Services). The Network Advertising Initiative has developed a tool that may help you understand which third parties have currently enabled cookies for your browser and how to opt out of those cookies. For more information and to opt out of interest-based advertising, you can visit{' '}
            <a href="http://optout.networkadvertising.org/" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">this page</a>.
          </p>

          {/* Section 5 */}
          <h2 className="text-2xl font-bold text-white mt-10 mb-4">5. Who has access to your information?</h2>
          <p>
            Postiz does not rent or sell your information. We restrict access to your information to authorized employees and we do not share your information with third parties except in the circumstances explained below.
          </p>

          <h3 className="text-xl font-semibold text-white mt-6 mb-3">Authorized Contractors</h3>
          <p>
          ...
          <h3 className="text-xl font-semibold text-white mt-6 mb-3">Service Providers, Authorized Resellers, and Partners</h3>
          <p>
          ...
          <h3 className="text-xl font-semibold text-white mt-6 mb-3">Social Networks and Third-Party Services</h3>
          <p>
            Where you are using our Services and have chosen to connect your Social Networks to the Services, or if you authorize a Third-Party Service to access your account, you are agreeing to provide information about you to the Social Networks and the Third-Party Services under their respective terms and privacy policies. For example, if you choose to connect your YouTube account to the Services, this connection uses YouTube's API services, and the{' '}
            <a href="https://www.google.com/policies/privacy" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">Google Privacy Policy</a>{' '}
            will apply to you.
          </p>

          <h3 className="text-xl font-semibold text-white mt-6 mb-3">Customer Organizations</h3>
          <p>
          ...
          <h3 className="text-xl font-semibold text-white mt-6 mb-3">Successor and Affiliated Entities</h3>
          <p>
            We may share information about you among Postiz-controlled affiliates and subsidiaries, and they will protect your information in a manner that is consistent with this Privacy Policy and where applicable, in accordance with the privacy policy specific to the entity.
          </p>
          <p>
          ...
          <h3 className="text-xl font-semibold text-white mt-6 mb-3">Law Enforcement, Government Agencies, and Professional Advisors</h3>
          <p>
          ...
          {/* Section 6 */}
          <h2 className="text-2xl font-bold text-white mt-10 mb-4">6. What international data transfers occur at Postiz?</h2>
          <p>
          ...
          {/* Section 7 */}
          <h2 className="text-2xl font-bold text-white mt-10 mb-4">7. How do we safeguard your information?</h2>
          <p>
            Postiz maintains industry standard security safeguards to protect your information. This includes ensuring our employees receive appropriate security and privacy training and guidance so they are aware of the measures they need to implement to protect your information.
          </p>
          <p>
            Access controls are in place to limit access to your information to those who need it to perform their jobs. Individuals who are permitted to handle your information must adhere to confidentiality obligations.
          </p>
          <p>
          ...
          {/* Section 9 */}
          <h2 className="text-2xl font-bold text-white mt-10 mb-4">9. Postiz's roles under the GDPR and UK data protection laws</h2>
          <p>
            Depending on the situation and the type of data involved, Postiz may act as a data controller or a data processor.
          </p>

          <h3 className="text-xl font-semibold text-white mt-6 mb-3">Postiz as a data controller</h3>
          ...
          <h3 className="text-xl font-semibold text-white mt-6 mb-3">Legal bases for processing when Postiz is a data controller</h3>
          ...
          <ul className="list-disc pl-6 space-y-2">
            ...
            <li>In some cases, we may have a legal obligation to process your personal data to comply with relevant laws (for example, processing payroll and tax information to comply with relevant employment and tax legislation); or processing is necessary to protect your vital interests or those of another person.</li>
          </ul>

          <h3 className="text-xl font-semibold text-white mt-6 mb-3">Your rights when Postiz is a data controller</h3>
          <p>In addition, you may have the following rights:</p>
          <ul className="list-disc pl-6 space-y-2">
            <li><strong className="text-white">Right to object to processing:</strong> You may request that Postiz stop processing information about you (for example, stop sending you marketing communications).</li>
            <li><strong className="text-white">Right to restrict processing:</strong> You may request that we restrict the processing of information about you (for example, where you believe that this information is inaccurate).</li>
            <li><strong className="text-white">Right to data portability:</strong> You may request that we provide you with information Postiz has about you in a structured, machine-readable, and commonly used format or transfer this information to another data controller.</li>
          </ul>

          <h3 className="text-xl font-semibold text-white mt-6 mb-3">Postiz as a data processor</h3>
          <p>
            When you use our Services and make decisions about the personal data being processed in them (including selecting the Social Network accounts you wish to connect to the Services or uploading and using Content), you are acting as a data controller, and Postiz is acting as a data processor.
          </p>
          <p>
            As a data controller, you have certain obligations under the GDPR, including managing Content on the Services. As a data processor, Postiz will only access and process Content to provide you with the Services by your instructions (which you provide through the Services), the Terms of Service, the Social Networks' terms, and applicable laws.
          </p>

          {/* Section 10 */}
          <h2 className="text-2xl font-bold text-white mt-10 mb-4">10. Your California Privacy Rights</h2>
          <p>
            Suppose you are a consumer as defined in the California Consumer Privacy Act (CCPA) and as amended by the California Privacy Rights Act (CPRA) (collectively, "California Privacy Laws"). In that case, the following provisions apply to you.
          </p>
          ...
          {/* Section 11 */}
          <h2 className="text-2xl font-bold text-white mt-10 mb-4">11. Changes to this Privacy Policy</h2>
          <p>
